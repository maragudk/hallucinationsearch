...
// Image is a fabricated image generated by Nano Banana and cached in SQLite.
// The primary key is the sha256 hex of the normalised prompt path, so repeat
// requests for the same prompt reuse the cached bytes.
type Image struct {
